...
namespace DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://KnockKnock.readify.net", ConfigurationName="ReadifyRedPill.IRedPill")]
    public interface IRedPill {
        ...
        DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.TriangleType WhatShapeIsThis(int a, int b, int c);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://KnockKnock.readify.net/IRedPill/WhatShapeIsThis", ReplyAction="http://KnockKnock.readify.net/IRedPill/WhatShapeIsThisResponse")]
        System.Threading.Tasks.Task<DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.TriangleType> WhatShapeIsThisAsync(int a, int b, int c);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IRedPillChannel : DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.IRedPill, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RedPillClient : System.ServiceModel.ClientBase<DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.IRedPill>, DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.IRedPill {
        ...
        public DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.TriangleType WhatShapeIsThis(int a, int b, int c) {
            return base.Channel.WhatShapeIsThis(a, b, c);
        }
        
        public System.Threading.Tasks.Task<DigiAeon.KnockKnock.Services.Tests.ReadifyRedPill.TriangleType> WhatShapeIsThisAsync(int a, int b, int c) {
